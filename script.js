...
class House extends Residence{
    ...
    constructor(endereco, cep, metros, banheiros, quartos, moradores, valor, quintal){
    ...
    TotalValueHouse(valor){
        let valorTotal = Number(valor * 1.30)
...
class Apartment extends Residence{
    ...
    constructor(endereco, cep, metros, banheiros, quartos, moradores, valor, andar, valorCondominio){
        super(endereco, cep, metros, banheiros, quartos, moradores, valor)
        this.Andar = andar
...
while(choice){
    choice = prompt("1 Cadastrar Pessoa /// 2 Residências /// 3 Encerrar Programa")
    switch(choice){
        case "1":
        ...
        case "2":
        choice = prompt("1 Cadastrar Casa /// 2 Cadastrar Apartamento /// 3 Cadastar Kitnet /// 4 Remover Morador /// 5 Adicionar Morador")
        switch(choice){
            case "1":
            CreateHouse()
            break;
...
function CreateHouse(){
    ...
    if(banheiros == "" || banheiros > 5 || quintal == "" || valor == ""){
        ...
        let NewHouse = new House(endereco, cep, metros, banheiros, quartos, valor, quintal)
...
function CreateApartament(){
    ...
    let banheiros = Number(prompt("Quantos banheiros tem a apartamento ? (Máximo 3)"))
    ...
    let valorCondominio = Number(prompt("Qual o valor do condominio do apartamento ?"))

    if(banheiros == "" || banheiros > 3 || valor == "" || valorCondominio == ""){
        return alert("Algum valor foi preenchido de maneira incorreta")
    }

            
    let NewApartament = new Apartment(endereco, cep, metros, banheiros, quartos, valor, andar, valorCondominio)
